...
// detach and re-insert the avl node to update score
...
// add a new (score, name) tuple, or update score if name already exists
...
// find the (score, name) tuple that is greater or equal to the arg
